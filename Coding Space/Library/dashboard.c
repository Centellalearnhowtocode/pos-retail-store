...
GtkWidget* create_numpad() {
    ...
    for (int i = 0; i < 20; i++) {
        ...
        gtk_widget_set_name(btn, (g_strcmp0(labels[i], "Void") == 0) ? "btn-void" : (g_strcmp0(labels[i], "Submit") == 0) ? "btn-submit" : "btn-pos");
...
int main(int argc, char *argv[]) {
    ...
    gtk_box_pack_start(GTK_BOX(right_vbox), order_list, TRUE, TRUE, 0);
