...
static void load_css(void) {
    const char *css =
        "window { background: #d7d7d7; }"
        ".app-bg { background: #383b52; }"
        ".top-bar { background: #00384f; }"
        ".header-small { color: #130127; font-size: 10px; }"
        ".product-area { background: #d7d7d7; }"
        ".bottom-bar { background: #00384f; }"
        ".product-card { background-image:url('Retail.jpg') ; background-size: cover; background-position: center; background: #ffffff; border: 0; border-radius: 13px; color: #00384f; }"
        ".product-card:hover { background: #f9f9f9; }"
        ".product-selected { background: #c7c66a; }"
        ...
        ".category-button { background-image: none; background: #ffffff; color: #00384f; border: 0; border-radius: 0; font-size: 10px; }"
        ".receipt-bg { background: #fff1cf; }"
        ".receipt-heading { color: #00384f; font-size: 10px; }"
        ".order-row { background: #fffaf0; border-top: 1px solid #ebd5ab; }"
        ".order-name { color: #00384f; font-size: 10px; }"
        ".order-discount { color: #00384f; font-size: 6px; }"
        ".totals-bg { background: #fffaf0; border-top: 4px solid #00384f; }"
        ".tiny-text { color: #00384f; font-size: 7px; }"
        ".key-button { background-image: none; background: #ffffff;ss color: #00384f; border: 0; border-radius: 0; font-size: 9px; }"
        ".key-button:hover { background: #edf6fb; }"
        ".key-red { background-image: none; background: #df0617; color: #00384f; border: 0; border-radius: 0; font-size: 9px; }"
        ".key-green { background-image: none; background: #63be63; color: #ffffff; border: 0; border-radius: 0; font-size: 9px; }"
        ".receipt-text { background: #fff1cf; color: #00384f; font-family: monospace; font-size: 10px; padding: 8px; }"
        ".login-card { background: #00384f; border-radius: 14px; }"
        ".login-title { color: #72aeca; font-size: 10px; font-weight: bold; }"
        ".small-login-label { color: #8fc2dc; font-size: 6px; }"
        ".cream-entry { background-image: none; background: #fff2d2; color: #000000; border-radius: 6px; border: 0; padding: 10px; }"
        ".green-button { background-image: none; background: #63be63; color: #000000; border-radius: 3px; border: 0; font-size: 10px; }"
        ".red-button { background-image: none; background: #df0617; color: #000000; border-radius: 3px; border: 0; font-size: 10px; }";
